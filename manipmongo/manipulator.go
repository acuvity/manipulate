...
// mongoManipulator is kept as a type alias so package-internal references still
// compile during the staged migration. Runtime behavior is fully implemented by
// mongoDriverManipulator.
type mongoManipulator = mongoDriverManipulator
