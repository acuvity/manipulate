...
func TestMongoManipulatorBranchCoverageWithMemongo(t *testing.T) {
	...
	t.Run("count_empty_collection", func(t *testing.T) {
		...
		emptyManipulator, err := New(uri, dbEmpty, OptionForceReadFilter(mongobson.D{}))
		if err != nil {
...
func TestMongoManipulatorExplainBranchesWithMemongo(t *testing.T) {
	...
	manipulator, err := New(uri, db, OptionExplain(explainOps), OptionForceReadFilter(mongobson.D{}))
	if err != nil {
