...
func TestHTTP_RetrieveMany(t *testing.T) {
	...
	Convey("Given I have a manipulator and a working server", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"ID": "1", "name": "name1"}, {"ID": "2", "name": "name2"}]`)
		}))
		defer ts.Close()
...
func TestHTTP_Retrieve(t *testing.T) {
	...
	Convey("Given I have a manipulator and a working server", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			_, _ = fmt.Fprint(w, `{"ID":"xxx","name":"the list 1"}`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a manipulator and a and the server will return an error", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(422)
			_, _ = fmt.Fprint(w, `[{"code":422,"description":"nope.","subject":"elemental","title":"Read Only Error","data":null}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a manipulator and the server returns a bad json", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			_, _ = fmt.Fprint(w, `not good at all`)
		}))
		defer ts.Close()
...
func TestHTTP_Update(t *testing.T) {
	...
	Convey("Given I have a manipulator and a working server", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			_, _ = fmt.Fprint(w, `{"ID": "zzz", "parentType": "pedro", "parentID": "yyy"}`)
		}))
		defer ts.Close()
...
func TestHTTP_send(t *testing.T) {
	...
	Convey("Given I have a server and a retry func and I call send", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 408, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 502", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 502, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 503", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 503, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 504", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 504, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 429", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 429, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 403 and no token manager", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 403, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 423", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			...
			_, _ = fmt.Fprint(w, `[{"code": 423, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
	...
	Convey("Given I have a server returning 500", t, func() {
		...
		ts := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
			w.Header().Set("Content-Type", "application/json")
			w.WriteHeader(http.StatusInternalServerError)
			_, _ = fmt.Fprint(w, `[{"code": 500, "title": "nope", "description": "boom"}]`)
		}))
		defer ts.Close()
